									 ...
									 fiid_obj_t obj_cmd_rq)
{
  ...
  if (FIID_OBJ_TEMPLATE_COMPARE (obj_cmd_rq, tmpl_cmd_set_system_info_parameters_present_os_version_number_first_set_rq) < 0)
    {
      ERRNO_TRACE (errno);
      return (-1);
    }
  ...
  FILL_FIID_OBJ_CLEAR (obj_cmd_rq);
  FILL_FIID_OBJ_SET (obj_cmd_rq, "cmd", IPMI_CMD_SET_SYSTEM_INFO_PARAMETERS);
  FILL_FIID_OBJ_SET (obj_cmd_rq, "parameter_selector", IPMI_SYSTEM_INFO_PARAMETER_PRESENT_OS_VERSION_NUMBER);
  FILL_FIID_OBJ_SET (obj_cmd_rq, "set_selector", set_selector);
  FILL_FIID_OBJ_SET (obj_cmd_rq, "encoding", encoding);
  FILL_FIID_OBJ_SET (obj_cmd_rq, "reserved", 0);
  FILL_FIID_OBJ_SET (obj_cmd_rq, "string_length", string_length);
							       ...
							       fiid_obj_t obj_cmd_rq)
{
  ...
  if (FIID_OBJ_TEMPLATE_COMPARE (obj_cmd_rq, tmpl_cmd_set_system_info_parameters_present_os_version_number_rq) < 0)
    {
      ERRNO_TRACE (errno);
      return (-1);
    }
						       ...
						       fiid_obj_t obj_cmd_rq)
{
  ...
  if (FIID_OBJ_TEMPLATE_COMPARE (obj_cmd_rq, tmpl_cmd_set_system_info_parameters_bmc_url_first_set_rq) < 0)
    {
      ERRNO_TRACE (errno);
      return (-1);
    }
  ...
  FILL_FIID_OBJ_CLEAR (obj_cmd_rq);
  FILL_FIID_OBJ_SET (obj_cmd_rq, "cmd", IPMI_CMD_SET_SYSTEM_INFO_PARAMETERS);
  FILL_FIID_OBJ_SET (obj_cmd_rq, "parameter_selector", IPMI_SYSTEM_INFO_PARAMETER_BMC_URL);
  FILL_FIID_OBJ_SET (obj_cmd_rq, "set_selector", set_selector);
  FILL_FIID_OBJ_SET (obj_cmd_rq, "encoding", encoding);
  FILL_FIID_OBJ_SET (obj_cmd_rq, "reserved", 0);
  FILL_FIID_OBJ_SET (obj_cmd_rq, "string_length", string_length);
					     ...
					     fiid_obj_t obj_cmd_rq)
{
  ...
  if (FIID_OBJ_TEMPLATE_COMPARE (obj_cmd_rq, tmpl_cmd_set_system_info_parameters_bmc_url_rq) < 0)
    {
      ERRNO_TRACE (errno);
      return (-1);
    }
								      ...
								      fiid_obj_t obj_cmd_rq)
{
  ...
  if (FIID_OBJ_TEMPLATE_COMPARE (obj_cmd_rq, tmpl_cmd_set_system_info_parameters_base_os_hypervisor_url_first_set_rq) < 0)
    {
      ERRNO_TRACE (errno);
      return (-1);
    }
  ...
  FILL_FIID_OBJ_CLEAR (obj_cmd_rq);
  FILL_FIID_OBJ_SET (obj_cmd_rq, "cmd", IPMI_CMD_SET_SYSTEM_INFO_PARAMETERS);
  FILL_FIID_OBJ_SET (obj_cmd_rq, "parameter_selector", IPMI_SYSTEM_INFO_PARAMETER_BASE_OS_HYPERVISOR_URL);
  FILL_FIID_OBJ_SET (obj_cmd_rq, "set_selector", set_selector);
  FILL_FIID_OBJ_SET (obj_cmd_rq, "encoding", encoding);
  FILL_FIID_OBJ_SET (obj_cmd_rq, "reserved", 0);
  FILL_FIID_OBJ_SET (obj_cmd_rq, "string_length", string_length);
							    ...
							    fiid_obj_t obj_cmd_rq)
{
  ...
  if (FIID_OBJ_TEMPLATE_COMPARE (obj_cmd_rq, tmpl_cmd_set_system_info_parameters_base_os_hypervisor_url_rq) < 0)
    {
      ERRNO_TRACE (errno);
      return (-1);
    }
