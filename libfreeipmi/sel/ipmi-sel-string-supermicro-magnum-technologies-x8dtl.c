                                                                              ...
                                                                              struct ipmi_sel_system_event_record_data *system_event_record_data)
{
  ...
  assert (ctx->manufacturer_id == IPMI_IANA_ENTERPRISE_ID_MAGNUM_TECHNOLOGIES);
  assert (sel_entry);
  assert (tmpbuf);
  assert (tmpbuflen);
  ...
  assert (ctx->product_id == IPMI_SUPERMICRO_PRODUCT_ID_MAGNUM_TECHNOLOGIES_X8DTL);
...
struct sel_string_oem sel_string_oem_supermicro_magnum_technologies_x8dtl =
  {
    NULL,
    NULL,
    &sel_string_output_supermicro_magnum_technologies_x8dtl_event_data1_class_oem,
    NULL,
    NULL,
    NULL,
    NULL,
