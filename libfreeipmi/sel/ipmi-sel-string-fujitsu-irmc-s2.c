...
#include "ipmi-sel-string-fujitsu-irmc-s2.h"
 ...
 */
int
sel_string_output_fujitsu_irmc_s2_event_data1_class_sensor_specific_discrete (ipmi_sel_ctx_t ctx,
 ...
 */
int
sel_string_output_fujitsu_irmc_s2_event_data2_event_data3 (ipmi_sel_ctx_t ctx,
							   struct ipmi_sel_entry *sel_entry,
							   uint8_t sel_record_type,
							   char *buf,
							   unsigned int buflen,
 ...
 */
int
sel_string_output_fujitsu_irmc_s2_oem_record_data (ipmi_sel_ctx_t ctx,
						   struct ipmi_sel_entry *sel_entry,
						   uint8_t sel_record_type,
						   char *buf,
						   unsigned int buflen,
 ...
 */
int
sel_string_output_fujitsu_irmc_s2_oem_string (ipmi_sel_ctx_t ctx,
					      struct ipmi_sel_entry *sel_entry,
					      uint8_t sel_record_type,
					      char *buf,
					      unsigned int buflen,
