 ...
 */
int
sel_string_output_wistron_c6220_event_data1_class_sensor_specific_discrete (ipmi_sel_ctx_t ctx,
 ...
 */
int
sel_string_output_wistron_c6220_event_data2_discrete_oem (ipmi_sel_ctx_t ctx,
                                                          struct ipmi_sel_entry *sel_entry,
                                                          uint8_t sel_record_type,
                                                          char *tmpbuf,
                                                          unsigned int tmpbuflen,
 ...
 */
int
sel_string_output_wistron_c6220_event_data3_discrete_oem (ipmi_sel_ctx_t ctx,
                                                          struct ipmi_sel_entry *sel_entry,
                                                          uint8_t sel_record_type,
                                                          char *tmpbuf,
                                                          unsigned int tmpbuflen,
 ...
 */
int
sel_string_output_wistron_c6220_event_data2_event_data3 (ipmi_sel_ctx_t ctx,
                                                         struct ipmi_sel_entry *sel_entry,
                                                         uint8_t sel_record_type,
                                                         char *buf,
                                                         unsigned int buflen,
