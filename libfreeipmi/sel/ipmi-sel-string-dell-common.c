 ...
 */
int
sel_string_output_dell_poweredge_generation11_event_data1_class_oem (ipmi_sel_ctx_t ctx,
								     struct ipmi_sel_entry *sel_entry,
								     uint8_t sel_record_type,
								     char *tmpbuf,
								     unsigned int tmpbuflen,
 ...
 */
int
sel_string_output_dell_oem_diagnostic_event_data_common_event_data1_class_oem (ipmi_sel_ctx_t ctx,
									       struct ipmi_sel_entry *sel_entry,
									       uint8_t sel_record_type,
									       char *tmpbuf,
									       unsigned int tmpbuflen,
 ...
 */
int
sel_string_output_dell_oem_diagnostic_event_data_common_event_data2_class_oem (ipmi_sel_ctx_t ctx,
									       struct ipmi_sel_entry *sel_entry,
									       uint8_t sel_record_type,
									       char *tmpbuf,
									       unsigned int tmpbuflen,
 ...
 */
int
sel_string_output_dell_oem_diagnostic_event_data_event_data3_class_oem (ipmi_sel_ctx_t ctx,
									struct ipmi_sel_entry *sel_entry,
									uint8_t sel_record_type,
									char *tmpbuf,
									unsigned int tmpbuflen,
