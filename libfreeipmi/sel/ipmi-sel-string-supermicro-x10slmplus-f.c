 ...
 */
int
sel_string_output_supermicro_x10slmplus_f_event_data2_event_data3 (ipmi_sel_ctx_t ctx,
...
struct sel_string_oem sel_string_oem_supermicro_x10slmplus_f =
  {
    NULL,
    NULL,
    NULL,
    ...
    NULL,
    NULL,
    &sel_string_output_supermicro_x10slmplus_f_event_data2_event_data3,
    NULL,
    NULL,
  };
