 ...
 */
int
sel_string_output_supermicro_x9dri_f_event_data1_class_oem (ipmi_sel_ctx_t ctx,
							    ...
							    struct ipmi_sel_system_event_record_data *system_event_record_data)
{
  ...
  assert (ctx->product_id == IPMI_SUPERMICRO_PRODUCT_ID_X9DRI_F);
...
struct sel_string_oem sel_string_oem_supermicro_x9dri_f =
  {
    NULL,
    NULL,
    &sel_string_output_supermicro_x9dri_f_event_data1_class_oem,
    NULL,
    NULL,
    NULL,
    NULL,
