                                             ...
                                             int *oem_rv)
{
  ...
  assert (oem_rv);
  assert (ctx->product_id == IPMI_INVENTEC_PRODUCT_ID_5441);
...
struct sel_string_oem sel_string_oem_inventec_5441 =
  {
    sel_string_output_inventec_5441_sensor_name,
    NULL,
    sel_string_output_inventec_5441_event_data1_class_oem,
    NULL,
    sel_string_output_inventec_5441_event_data2_discrete_oem,
    sel_string_output_inventec_5441_event_data2_class_oem,
    NULL,
    sel_string_output_inventec_5441_event_data3_discrete_oem,
    sel_string_output_inventec_5441_event_data3_class_oem,
    sel_string_output_inventec_5441_event_data2_event_data3,
    NULL,
    NULL,
  };
