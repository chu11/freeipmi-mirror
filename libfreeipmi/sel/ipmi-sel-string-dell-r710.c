 ...
 */
int
sel_string_output_dell_r710_event_data1_class_sensor_specific_discrete (ipmi_sel_ctx_t ctx,
									...
									struct ipmi_sel_system_event_record_data *system_event_record_data)
{
  ...
  assert (ctx->product_id == IPMI_DELL_PRODUCT_ID_POWEREDGE_R710);
 ...
 */
int
sel_string_output_dell_r710_event_data1_class_oem (ipmi_sel_ctx_t ctx,
						   struct ipmi_sel_entry *sel_entry,
						   uint8_t sel_record_type,
						   char *tmpbuf,
						   unsigned int tmpbuflen,
						   ...
						   struct ipmi_sel_system_event_record_data *system_event_record_data)
{
  ...
  if ((ret = sel_string_output_dell_poweredge_generation11_event_data1_class_oem (ctx,
										  sel_entry,
										  sel_record_type,
										  tmpbuf,
										  tmpbuflen,
 ...
 */
int
sel_string_output_dell_r710_event_data2_discrete_oem (ipmi_sel_ctx_t ctx,
						      struct ipmi_sel_entry *sel_entry,
						      uint8_t sel_record_type,
						      char *tmpbuf,
						      unsigned int tmpbuflen,
 ...
 */
int
sel_string_output_dell_r710_event_data2_class_oem (ipmi_sel_ctx_t ctx,
						   struct ipmi_sel_entry *sel_entry,
						   uint8_t sel_record_type,
						   char *tmpbuf,
						   unsigned int tmpbuflen,
 ...
 */
int
sel_string_output_dell_r710_event_data3_discrete_oem (ipmi_sel_ctx_t ctx,
						      struct ipmi_sel_entry *sel_entry,
						      uint8_t sel_record_type,
						      char *tmpbuf,
						      unsigned int tmpbuflen,
 ...
 */
int
sel_string_output_dell_r710_event_data3_class_oem (ipmi_sel_ctx_t ctx,
						   struct ipmi_sel_entry *sel_entry,
						   uint8_t sel_record_type,
						   char *tmpbuf,
						   unsigned int tmpbuflen,
 ...
 */
int
sel_string_output_dell_r710_event_data2_event_data3 (ipmi_sel_ctx_t ctx,
						     struct ipmi_sel_entry *sel_entry,
						     uint8_t sel_record_type,
						     char *buf,
						     unsigned int buflen,
