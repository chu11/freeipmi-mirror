/* 
   ipmi-sol-param-spec.h - IPMI SOL parameters spec
...
#define IPMI_SOL_PARAM_CHARACTER_ACCUMULATE_INTERVAL_AND_SEND_THRESHOLD 3
#define IPMI_SOL_PARAM_SOL_RETRY                                        4
#define IPMI_SOL_PARAM_SOL_NON_VOLATILE_BIT_RATE                        5
