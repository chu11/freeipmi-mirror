...
#ifndef _IPMI_LAN_CONFIGURATION_PARAMETERS_SPEC_H
#define _IPMI_LAN_CONFIGURATION_PARAMETERS_SPEC_H 1
...
#define IPMI_LAN_CONFIGURATION_PARAMETER_PRIMARY_RMCP_PORT_NO                             8
#define IPMI_LAN_CONFIGURATION_PARAMETER_SECONDARY_RMCP_PORT_NO                           9
