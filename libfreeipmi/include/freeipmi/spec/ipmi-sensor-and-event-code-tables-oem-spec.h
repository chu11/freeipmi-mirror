...
#define IPMI_SENSOR_TYPE_VERSION_CHANGE_OEM_DELL_OTHER 0x00
#define IPMI_SENSOR_TYPE_VERSION_CHANGE_OEM_DELL_CPU   0x01

#define IPMI_SENSOR_TYPE_VERSION_CHANGE_DEVICE_OPTION_ROM_BITMASK 0x80
#define IPMI_SENSOR_TYPE_VERSION_CHANGE_DEVICE_OPTION_ROM_SHIFT   7

#define IPMI_SENSOR_TYPE_VERSION_CHANGE_DEVICE_OPTION_ROM_EMBEDDED 0
#define IPMI_SENSOR_TYPE_VERSION_CHANGE_DEVICE_OPTION_ROM_SLOT     1

#define IPMI_SENSOR_TYPE_VERSION_CHANGE_DEVICE_OPTION_ROM_SLOT_BITMASK 0x7F
#define IPMI_SENSOR_TYPE_VERSION_CHANGE_DEVICE_OPTION_ROM_SLOT_SHIFT   0
