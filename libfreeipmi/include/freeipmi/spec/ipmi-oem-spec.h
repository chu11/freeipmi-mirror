 ...
 * dedicated nic 10b/100b - boolean
 * nic selection - uint8
 * nic enable - boolean
 * ipv4 enable - boolean
 */
...
/* w/ IPMI_CMD_OEM_WISTRON_GET_PASSWORD_POLICY
 * IPMI_CMD_OEM_WISTRON_SET_PASSWORD_POLICY
 */
#define IPMI_CMD_OEM_WISTRON_PASSWORD_POLICY_DISABLE 0x00
#define IPMI_CMD_OEM_WISTRON_PASSWORD_POLICY_ENABLE  0x01
