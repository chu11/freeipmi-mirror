...
enum ipmi_errnum
  {
    ...
    IPMI_ERR_CIPHER_SUITE_UNAVAILABLE = 8,
    IPMI_ERR_PASSWORD_VERIFICATION_TIMEOUT = 9,
    IPMI_ERR_IPMI_2_0_UNAVAILABLE = 10,
    IPMI_ERR_SESSION_TIMEOUT = 11,
    IPMI_ERR_DEVICE_ALREADY_OPEN = 12,
    IPMI_ERR_DEVICE_NOT_OPEN = 13,
    IPMI_ERR_DEVICE_NOT_SUPPORTED = 14,
    IPMI_ERR_DEVICE_NOT_FOUND = 15,
    IPMI_ERR_BAD_COMPLETION_CODE_NODE_BUSY = 16,
    IPMI_ERR_BAD_COMPLETION_CODE_INVALID_COMMAND = 17,
    IPMI_ERR_BAD_COMPLETION_CODE_REQUEST_DATA_INVALID = 18,
    IPMI_ERR_BAD_COMPLETION_CODE_INSUFFICIENT_PRIVILEGE = 19,
    IPMI_ERR_BAD_COMPLETION_CODE = 20,
    IPMI_ERR_BAD_RMCPPLUS_STATUS_CODE = 21,
    IPMI_ERR_BMC_BUSY = 22,
    IPMI_ERR_OUT_OF_MEMORY = 23,
    IPMI_ERR_INVALID_HOSTNAME = 24,
    IPMI_ERR_INVALID_PARAMETERS = 25,
    IPMI_ERR_DRIVER_PATH_REQUIRED = 26,
    IPMI_ERR_INTERNAL_IPMI_ERROR = 27,
    IPMI_ERR_INTERNAL_SYSTEM_ERROR = 28,
    IPMI_ERR_INTERNAL_LIBRARY_ERROR = 29,
    IPMI_ERR_INTERNAL_ERROR = 30,
    IPMI_ERR_OUTOFRANGE = 31,
  };
