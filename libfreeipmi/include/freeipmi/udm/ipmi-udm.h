...
enum ipmi_errnum
  {
    ...
    IPMI_ERR_INVALID_PARAMETERS = 17,
    IPMI_ERR_DRIVER_PATH_REQUIRED = 18,
    IPMI_ERR_INTERNAL_IPMI_ERROR = 19,
    IPMI_ERR_INTERNAL_SYSTEM_ERROR = 20,
    IPMI_ERR_INTERNAL_LIBRARY_ERROR = 21,
    IPMI_ERR_INTERNAL_ERROR = 22,
    IPMI_ERR_OUTOFRANGE = 23,
  };
