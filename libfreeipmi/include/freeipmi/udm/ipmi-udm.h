...
enum ipmi_errnum
  {
    ...
    IPMI_ERR_DEVICE_NOT_FOUND = 12,
    IPMI_ERR_BAD_COMPLETION_CODE = 13,
    IPMI_ERR_BMC_BUSY = 14,
    IPMI_ERR_OUT_OF_MEMORY = 15,
    IPMI_ERR_INVALID_PARAMETERS = 16,
    IPMI_ERR_DRIVER_PATH_REQUIRED = 17,
    IPMI_ERR_INTERNAL_IPMI_ERROR = 18,
    IPMI_ERR_INTERNAL_SYSTEM_ERROR = 19,
    IPMI_ERR_INTERNAL_LIBRARY_ERROR = 20,
    IPMI_ERR_INTERNAL_ERROR = 21,
    IPMI_ERR_OUTOFRANGE = 22,
  };
