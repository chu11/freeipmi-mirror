...
/* $Id: ipmi-pef-and-alerting-cmds-udm.h,v 1.9 2007-05-15 03:07:02 balamurugan Exp $ */
...
int8_t ipmi_cmd_get_pef_configuration_parameters_alert_string (ipmi_device_t dev,
							       ...
							       uint8_t block_selector, 
							       fiid_obj_t obj_cmd_rs);
int8_t ipmi_cmd_get_pef_configuration_parameters_alert_policy_table (ipmi_device_t dev, 
								     uint8_t get_parameter, 
								     uint8_t set_selector, 
								     uint8_t block_selector, 
								     fiid_obj_t obj_cmd_rs);
