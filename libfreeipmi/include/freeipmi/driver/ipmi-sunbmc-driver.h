...
#define IPMI_SUNBMC_ERR_IO_NOT_INITIALIZED  6
#define IPMI_SUNBMC_ERR_OUT_OF_MEMORY       7
#define IPMI_SUNBMC_ERR_DRIVER_TIMEOUT      8
#define IPMI_SUNBMC_ERR_IPMI_ERROR          9
#define IPMI_SUNBMC_ERR_SYSTEM_ERROR       10
#define IPMI_SUNBMC_ERR_INTERNAL_ERROR     11
#define IPMI_SUNBMC_ERR_ERRNUMRANGE        12
