...
int8_t ipmi_rmcpplus_check_message_tag(fiid_obj_t obj_cmd, uint8_t message_tag);

int8_t ipmi_rmcpplus_check_remote_console_session_id(fiid_obj_t obj_cmd, uint32_t remote_console_session_id);
