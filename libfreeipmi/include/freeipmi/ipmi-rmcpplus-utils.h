...
int32_t ipmi_calculate_keys(uint8_t payload_type,
...
int8_t ipmi_rmcpplus_check_rakp_message_2_key_exchange_authentication_code(int8_t authentication_algorithm, 
									   uint8_t *k_uid, 
									   uint32_t k_uid_len, 
									   uint32_t remote_console_session_id, 
...
int8_t ipmi_rmcpplus_check_rakp_message_4_integrity_check_value(int8_t authentication_algorithm, 
								uint8_t *sik_key, 
								uint32_t sik_key_len, 
								uint8_t *remote_console_random_number, 
								uint32_t remote_console_random_number_len, 
...
int8_t ipmi_rmcpplus_check_session_trlr(int8_t integrity_algorithm, 
					uint8_t *pkt, 
					uint32_t pkt_len, 
					uint8_t *integrity_key, 
					uint32_t integrity_key_len, 
