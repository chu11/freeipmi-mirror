...
int ipmi_locate_smbios_get_device_info (ipmi_interface_type_t type, struct ipmi_locate_info *info);

int ipmi_locate_pci_get_device_info (ipmi_interface_type_t type, struct ipmi_locate_info *info);

int ipmi_locate_acpi_spmi_get_device_info (ipmi_interface_type_t interface_type, struct ipmi_locate_info *info);

int ipmi_locate_defaults_get_device_info (ipmi_interface_type_t type, struct ipmi_locate_info *info);

int ipmi_locate_dmidecode_get_device_info (ipmi_interface_type_t type, struct ipmi_locate_info *info);
