...
enum ipmi_errnum
  {
    ...
    IPMI_ERR_BAD_COMPLETION_CODE_NODE_BUSY = 20,
    IPMI_ERR_BAD_COMPLETION_CODE_INVALID_COMMAND = 21,
    IPMI_ERR_BAD_COMPLETION_CODE_REQUEST_DATA_INVALID = 22,
