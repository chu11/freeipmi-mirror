...
enum ipmi_errnum
  {
    ...
    IPMI_ERR_DRIVER_TIMEOUT = 18,
    IPMI_ERR_BAD_COMPLETION_CODE_NODE_BUSY = 19,
    IPMI_ERR_BAD_COMPLETION_CODE_INVALID_COMMAND = 20,
    IPMI_ERR_BAD_COMPLETION_CODE_REQUEST_DATA_INVALID = 21,
    IPMI_ERR_BAD_COMPLETION_CODE = 22,
    IPMI_ERR_BAD_RMCPPLUS_STATUS_CODE = 23,
    IPMI_ERR_BMC_BUSY = 24,
    IPMI_ERR_OUT_OF_MEMORY = 25,
    IPMI_ERR_HOSTNAME_INVALID = 26,
    IPMI_ERR_PARAMETERS = 27,
    IPMI_ERR_DRIVER_PATH_REQUIRED = 28,
    IPMI_ERR_IPMI_ERROR = 29,
...
#define IPMI_WORKAROUND_FLAGS_IGNORE_SOL_PAYLOAD_SIZE     0x00010000
#define IPMI_WORKAROUND_FLAGS_IGNORE_SOL_PORT             0x00020000
