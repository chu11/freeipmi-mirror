...
enum ipmi_errnum
  {
    ...
    IPMI_ERR_COMMAND_INVALID_FOR_SELECTED_INTERFACE = 20,
    IPMI_ERR_BAD_COMPLETION_CODE_NODE_BUSY = 21,
    IPMI_ERR_BAD_COMPLETION_CODE_INVALID_COMMAND = 22,
    IPMI_ERR_BAD_COMPLETION_CODE_REQUEST_DATA_INVALID = 23,
