...
#define IPMI_OPENIPMI_CTX_ERR_DEVICE_NOTFOUND 5
#define IPMI_OPENIPMI_CTX_ERR_IO_INIT         6
#define IPMI_OPENIPMI_CTX_ERR_OUTMEM          7
#define IPMI_OPENIPMI_CTX_ERR_INTERNAL        8
#define IPMI_OPENIPMI_CTX_ERR_ERRNUMRANGE     9
