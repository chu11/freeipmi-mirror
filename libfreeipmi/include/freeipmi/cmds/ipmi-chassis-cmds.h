...
#define IPMI_CHASSIS_BOOT_OPTIONS_BOOT_FLAG_BOOT_DEVICE_FORCE_REMOTELY_CONNECTED_FLOPPY_PRIMARY_REMOVEABLE_MEDIA 0x07
#define IPMI_CHASSIS_BOOT_OPTIONS_BOOT_FLAG_BOOT_DEVICE_FORCE_PRIMARY_REMOTE_MEDIA                               0x09
#define IPMI_CHASSIS_BOOT_OPTIONS_BOOT_FLAG_BOOT_DEVICE_FORCE_REMOTELY_CONNECTED_CD_DVD                          0x08
#define IPMI_CHASSIS_BOOT_OPTIONS_BOOT_FLAG_BOOT_DEVICE_FORCE_REMOTELY_CONNECTED_HARD_DRIVE                      0x0B
...
#define IPMI_CHASSIS_BOOT_OPTIONS_BOOT_FLAG_BOOT_DEVICE_VALID(__boot_device)                                                       \
  (((__boot_device) == IPMI_CHASSIS_BOOT_OPTIONS_BOOT_FLAG_BOOT_DEVICE_NO_OVERRIDE                                                 \
    ...
    || (__boot_device) == IPMI_CHASSIS_BOOT_OPTIONS_BOOT_FLAG_BOOT_DEVICE_FORCE_REMOTELY_CONNECTED_FLOPPY_PRIMARY_REMOVEABLE_MEDIA \
    || (__boot_device) == IPMI_CHASSIS_BOOT_OPTIONS_BOOT_FLAG_BOOT_DEVICE_FORCE_PRIMARY_REMOTE_MEDIA                               \
    || (__boot_device) == IPMI_CHASSIS_BOOT_OPTIONS_BOOT_FLAG_BOOT_DEVICE_FORCE_REMOTELY_CONNECTED_CD_DVD                          \
    || (__boot_device) == IPMI_CHASSIS_BOOT_OPTIONS_BOOT_FLAG_BOOT_DEVICE_FORCE_REMOTELY_CONNECTED_HARD_DRIVE                      \
...
#define IPMI_CHASSIS_BOOT_OPTIONS_DEVICE_INSTANCE_SELECTOR_MIN 0x00
#define IPMI_CHASSIS_BOOT_OPTIONS_DEVICE_INSTANCE_SELECTOR_MAX 0x31

#define IPMI_CHASSIS_BOOT_OPTIONS_DEVICE_INSTANCE_SELECTOR_RANGE_MIN 0x01
#define IPMI_CHASSIS_BOOT_OPTIONS_DEVICE_INSTANCE_SELECTOR_RANGE_MAX 0x15

/* To avoid gcc warnings, add +1 in comparison */
#define IPMI_CHASSIS_BOOT_OPTIONS_DEVICE_INSTANCE_SELECTOR_VALID(__value) \
  ((((__value) + 1) >= (IPMI_CHASSIS_BOOT_OPTIONS_DEVICE_INSTANCE_SELECTOR_MIN + 1) \
    && (__value) <= IPMI_CHASSIS_BOOT_OPTIONS_DEVICE_INSTANCE_SELECTOR_MAX) ? 1 : 0)

#define IPMI_CHASSIS_BOOT_OPTIONS_DEVICE_INSTANCE_SELECTOR_RANGE_VALID(__value) \
  (((__value) >= IPMI_CHASSIS_BOOT_OPTIONS_DEVICE_INSTANCE_SELECTOR_RANGE_MIN \
    && (__value) <= IPMI_CHASSIS_BOOT_OPTIONS_DEVICE_INSTANCE_SELECTOR_RANGE_MAX) ? 1 : 0)
