...
#define KCS_ERRNUM_SET(__errnum)                                        \
  do {                                                                  \
    ctx->errnum = (__errnum);                                           \
    __MSG_TRACE(ipmi_kcs_ctx_errormsg(ctx), __errnum);                  \
  } while (0)
...
#define SSIF_ERRNUM_SET(__errnum)                                       \
  do {                                                                  \
    ctx->errnum = (__errnum);                                           \
    __MSG_TRACE(ipmi_ssif_ctx_errormsg(ctx), __errnum);                 \
  } while (0)
...
#define OPENIPMI_ERRNUM_SET(__errnum)                                   \
  do {                                                                  \
    ctx->errnum = (__errnum);                                           \
    __MSG_TRACE(ipmi_openipmi_ctx_errormsg(ctx), __errnum);             \
  } while (0)
...
#define SUNBMC_ERRNUM_SET(__errnum)                                     \
  do {                                                                  \
    ctx->errnum = (__errnum);                                           \
    __MSG_TRACE(ipmi_sunbmc_ctx_errormsg(ctx), __errnum);               \
  } while (0)
...
#endif /* ipmi-err-wrappers-driver.h */
