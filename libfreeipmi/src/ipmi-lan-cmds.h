...
int8_t ipmi_lan_set_arp (uint8_t channel_number, 
			 uint8_t bmc_generated_gratuitous_arps_flag, 
			 uint8_t bmc_generated_arp_responses_flag, 
			 fiid_obj_t obj_data_rs);

int8_t ipmi_lan_set_gratuitous_arp_interval (uint8_t channel_number, 
					     uint8_t gratuitous_arp_interval, 
					     fiid_obj_t obj_data_rs);

int8_t ipmi_lan_set_auth_type_enables (uint8_t channel_number, 
...
int8_t ipmi_suspend_bmc_arps (uint8_t channel_number, 
			      uint8_t gratuitous_arp_suspend, 
			      uint8_t arp_response_suspend, 
			      fiid_obj_t obj_data_rs);

int8_t ipmi_lan_get_arp (uint8_t channel_number, 
			 uint8_t parameter_type, 
			 uint8_t set_selector, 
			 uint8_t block_selector, 
			 fiid_obj_t obj_data_rs);

int8_t ipmi_lan_get_gratuitous_arp_interval (uint8_t channel_number, 
					     uint8_t parameter_type, 
					     uint8_t set_selector, 
					     uint8_t block_selector, 
					     fiid_obj_t obj_data_rs);

int8_t ipmi_lan_set_ip_addr_source (uint8_t channel_number,
				    uint8_t ip_addr_source,
				    fiid_obj_t data_rs);

int8_t ipmi_lan_get_ip_addr_source (uint8_t channel_number,
				    uint8_t parameter_type,
				    uint8_t set_selector,
				    uint8_t block_selector,
				    fiid_obj_t obj_data_rs);

int8_t ipmi_lan_set_ip_addr (uint8_t channel_number,
			     uint32_t ip_addr,
			     fiid_obj_t data_rs);

int8_t ipmi_lan_get_ip_addr (uint8_t channel_number,
			     uint8_t parameter_type,
			     uint8_t set_selector,
			     uint8_t block_selector,
			     fiid_obj_t obj_data_rs);

int8_t ipmi_lan_set_gw1_ip_addr (uint8_t channel_number,
				 uint32_t ip_addr,
				 fiid_obj_t data_rs);

int8_t ipmi_lan_get_gw1_ip_addr (uint8_t channel_number,
				 uint8_t parameter_type,
				 uint8_t set_selector,
				 uint8_t block_selector,
				 fiid_obj_t obj_data_rs);

int8_t ipmi_lan_set_gw2_ip_addr (uint8_t channel_number,
				 uint32_t ip_addr,
				 fiid_obj_t data_rs);

int8_t ipmi_lan_get_gw2_ip_addr (uint8_t channel_number,
				 uint8_t parameter_type,
				 uint8_t set_selector,
				 uint8_t block_selector,
				 fiid_obj_t obj_data_rs);

int8_t ipmi_lan_set_subnet_mask (uint8_t channel_number,
				 uint32_t ip_addr,
				 fiid_obj_t data_rs);

int8_t ipmi_lan_get_subnet_mask (uint8_t channel_number,
				 uint8_t parameter_type,
				 uint8_t set_selector,
				 uint8_t block_selector,
				 fiid_obj_t obj_data_rs);

int8_t ipmi_lan_set_mac_addr (uint8_t channel_number,
			      uint64_t mac_addr,
			      fiid_obj_t data_rs);

int8_t ipmi_lan_get_mac_addr (uint8_t channel_number,
			      uint8_t parameter_type,
			      uint8_t set_selector,
			      uint8_t block_selector,
			      fiid_obj_t obj_data_rs);

int8_t ipmi_lan_set_gw1_mac_addr (uint8_t channel_number,
				  uint64_t mac_addr,
				  fiid_obj_t data_rs);

int8_t ipmi_lan_get_gw1_mac_addr (uint8_t channel_number,
				  uint8_t parameter_type,
				  uint8_t set_selector,
				  uint8_t block_selector,
				  fiid_obj_t obj_data_rs);

int8_t ipmi_lan_set_gw2_mac_addr (uint8_t channel_number,
				  uint64_t mac_addr,
				  fiid_obj_t data_rs);

int8_t ipmi_lan_get_gw2_mac_addr (uint8_t channel_number,
				  uint8_t parameter_type,
				  uint8_t set_selector,
				  uint8_t block_selector,
				  fiid_obj_t obj_data_rs);

int8_t ipmi_lan_set_vlan_id (uint8_t channel_number,
                             uint8_t vlan_id_flag,
                             uint32_t vlan_id,
                             fiid_obj_t obj_data_rs);

int8_t ipmi_lan_get_vlan_id (uint8_t channel_number,
                             uint8_t parameter_type,
                             uint8_t set_selector,
                             uint8_t block_selector,
                             fiid_obj_t obj_data_rs);

int8_t ipmi_lan_set_vlan_priority (uint8_t channel_number,
                                   uint32_t vlan_priority,
                                   fiid_obj_t obj_data_rs);

int8_t ipmi_lan_get_vlan_priority (uint8_t channel_number,
                                   uint8_t parameter_type,
                                   uint8_t set_selector,
                                   uint8_t block_selector,
                                   fiid_obj_t obj_data_rs);
