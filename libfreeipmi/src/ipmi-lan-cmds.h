...
int8_t fill_lan_set_arp (uint8_t channel_number,
...
int8_t fill_lan_set_auth_type_enables (uint8_t channel_number,
                                       ...
                                       fiid_obj_t obj_data_rq);
int8_t fill_lan_set_ip_addr_source (uint8_t channel_number,
                                    uint8_t ip_addr_source,
                                    fiid_obj_t obj_data_rq);
int8_t fill_lan_set_ip_addr (uint8_t parameter_selector,
...
int8_t fill_lan_set_subnet_mask (uint8_t channel_number,
                                 ...
                                 fiid_obj_t obj_data_rq);
int8_t fill_lan_set_mac_addr (uint8_t parameter_selector,
                              uint8_t channel_number,
                              uint64_t mac_addr,
                              fiid_obj_t obj_data_rq);
