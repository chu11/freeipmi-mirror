...
/* $Id: ipmi-pef-cmds-udm.h,v 1.1.4.3 2006-02-16 21:31:05 chu11 Exp $ */
...
int8_t ipmi_cmd_set_pef_pef_control2 (ipmi_device_t *dev, 
                                      uint8_t pef, 
...
int8_t ipmi_cmd_set_pef_pef_action_global_control2 (ipmi_device_t *dev, 
...
int8_t ipmi_cmd_set_pef_pef_startup_delay2 (ipmi_device_t *dev, 
                                            uint8_t pef_startup_delay, 
                                            fiid_obj_t obj_cmd_rs);

int8_t ipmi_cmd_set_pef_pef_alert_startup_delay2 (ipmi_device_t *dev, 
                                                  uint8_t pef_alert_startup_delay, 
                                                  fiid_obj_t obj_cmd_rs);

int8_t ipmi_cmd_set_pef_event_filter_table2 (ipmi_device_t *dev, 
...
int8_t ipmi_cmd_set_pef_event_filter_table_data1_2 (ipmi_device_t *dev, 
                                                    uint8_t filter_number,
                                                    uint8_t filter_configuration_type,
                                                    uint8_t filter_configuration_filter,
                                                    fiid_obj_t obj_cmd_rs);

int8_t ipmi_cmd_get_pef_pef_control2 (ipmi_device_t *dev, 
                                      uint8_t get_parameter, 
                                      uint8_t set_selector, 
                                      uint8_t block_selector, 
                                      fiid_obj_t obj_cmd_rs);

int8_t ipmi_cmd_get_pef_pef_action_global_control2 (ipmi_device_t *dev, 
                                                    uint8_t get_parameter, 
                                                    uint8_t set_selector,
                                                    uint8_t block_selector, 
                                                    fiid_obj_t obj_cmd_rs);

int8_t ipmi_cmd_get_pef_pef_startup_delay2 (ipmi_device_t *dev, 
                                            uint8_t get_parameter, 
                                            uint8_t set_selector,
                                            uint8_t block_selector, 
                                            fiid_obj_t obj_cmd_rs);

int8_t ipmi_cmd_get_pef_pef_alert_startup_delay2 (ipmi_device_t *dev, 
                                                  uint8_t get_parameter, 
                                                  uint8_t set_selector,
                                                  uint8_t block_selector, 
                                                  fiid_obj_t obj_cmd_rs);

int8_t ipmi_cmd_get_pef_number_of_event_filters2 (ipmi_device_t *dev, 
                                                  uint8_t get_parameter, 
                                                  uint8_t set_selector,
                                                  uint8_t block_selector, 
                                                  fiid_obj_t obj_cmd_rs);

int8_t ipmi_cmd_get_pef_event_filter_table2 (ipmi_device_t *dev, 
                                            uint8_t get_parameter, 
                                            uint8_t set_selector,
                                            uint8_t block_selector, 
                                            fiid_obj_t obj_cmd_rs);

int8_t ipmi_cmd_get_pef_event_filter_table_data1_2 (ipmi_device_t *dev, 
                                                    uint8_t get_parameter, 
                                                    uint8_t set_selector, 
                                                    uint8_t block_selector, 
                                                    fiid_obj_t obj_cmd_rs);

int8_t ipmi_cmd_get_pef_number_of_alert_policy_entries2 (ipmi_device_t *dev,
                                                         uint8_t get_parameter, 
                                                         uint8_t set_selector,
                                                         uint8_t block_selector, 
                                                         fiid_obj_t obj_cmd_rs);

int8_t ipmi_cmd_get_pef_number_of_alert_strings2 (ipmi_device_t *dev, 
                                                  uint8_t get_parameter, 
                                                  uint8_t set_selector, 
                                                  uint8_t block_selector, 
                                                  fiid_obj_t obj_cmd_rs);
