...
#define IPMI_SESSION_AUTH_TYPE_RMCPPLUS            0x06
...
#define IPMI_SESSION_AUTH_TYPE_VALID(__auth_type) \
        (((__auth_type) == IPMI_SESSION_AUTH_TYPE_NONE \
          ...
          || (__auth_type) == IPMI_SESSION_AUTH_TYPE_OEM_PROP \
          || (__auth_type) == IPMI_SESSION_AUTH_TYPE_RMCPPLUS) ? 1 : 0) 

#define IPMI_1_5_SESSION_AUTH_TYPE_VALID(__auth_type) \
        (((__auth_type) == IPMI_SESSION_AUTH_TYPE_NONE \
          || (__auth_type) == IPMI_SESSION_AUTH_TYPE_MD2 \
          || (__auth_type) == IPMI_SESSION_AUTH_TYPE_MD5 \
          || (__auth_type) == IPMI_SESSION_AUTH_TYPE_STRAIGHT_PASSWD_KEY \
...
#define IPMI_2_0_SESSION_AUTH_TYPE_VALID(__auth_type) \
        IPMI_SESSION_AUTH_TYPE_VALID((__auth_type))
...
#define IPMI_PRIV_LEVEL_VALID(__priv_level) \
        (((__priv_level) == IPMI_PRIV_LEVEL_HIGHEST_LEVEL \
...
#define IPMI_1_5_PRIV_LEVEL_VALID(__priv_level) \
        (((__priv_level) == IPMI_PRIV_LEVEL_CALLBACK \
          || (__priv_level) == IPMI_PRIV_LEVEL_USER \
          || (__priv_level) == IPMI_PRIV_LEVEL_OPERATOR \
          || (__priv_level) == IPMI_PRIV_LEVEL_ADMIN \
...
#define IPMI_2_0_PRIV_LEVEL_VALID(__priv_level) \
        IPMI_PRIV_LEVEL_VALID(__priv_level)
