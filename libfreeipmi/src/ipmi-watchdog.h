...
#define IPMI_WATCHDOG_STOP_TIMER_ENABLE                          0x0
#define IPMI_WATCHDOG_STOP_TIMER_DISABLE                         0x1

#define IPMI_WATCHDOG_STOP_TIMER_VALID(__x) \
        (((__x) == IPMI_WATCHDOG_STOP_TIMER_ENABLE \
          || (__x) == IPMI_WATCHDOG_STOP_TIMER_DISABLE) ? 1 : 0)

#define IPMI_WATCHDOG_LOG_ENABLE                                 0x0
#define IPMI_WATCHDOG_LOG_DISABLE                                0x1
...
#define IPMI_WATCHDOG_TIMER_USE_EXPIRATION_CLEAR_TIMER_EXPIRATION_BIT  0x1
#define IPMI_WATCHDOG_TIMER_USE_EXPIRATION_LEAVE_ALONE                 0x0

#define IPMI_WATCHDOG_TIMER_USE_EXPIRATION_VALID(__x) \
        (((__x) == IPMI_WATCHDOG_TIMER_USE_EXPIRATION_CLEAR_TIMER_EXPIRATION_BIT \
          || (__x) == IPMI_WATCHDOG_TIMER_USE_EXPIRATION_LEAVE_ALONE) ? 1 : 0)

#define IPMI_WATCHDOG_TIMER_STATE_RUNNING                        0x1
#define IPMI_WATCHDOG_TIMER_STATE_STOPPED                        0x0
