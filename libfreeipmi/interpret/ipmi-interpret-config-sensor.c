...
static struct ipmi_interpret_sensor_config ipmi_interpret_sensor_drive_slot_transition_severity_config[] =
  {
    ...
    { "IPMI_Drive_Slot_Transition_Severity_Transition_To_OK", IPMI_INTERPRET_STATE_NOMINAL},
    { "IPMI_Drive_Slot_Transition_Severity_Transition_To_Non_Critical_From_OK", IPMI_INTERPRET_STATE_WARNING},
    { "IPMI_Drive_Slot_Transition_Severity_Transition_To_Critical_From_Less_Severe", IPMI_INTERPRET_STATE_CRITICAL},
    { "IPMI_Drive_Slot_Transition_Severity_Transition_To_Non_Recoverable_From_Less_Severe", IPMI_INTERPRET_STATE_CRITICAL},
    { "IPMI_Drive_Slot_Transition_Severity_Transition_To_Non_Critical_From_More_Severe", IPMI_INTERPRET_STATE_WARNING},
    { "IPMI_Drive_Slot_Transition_Severity_Transition_To_Critical_From_Non_Recoverable", IPMI_INTERPRET_STATE_CRITICAL},
    { "IPMI_Drive_Slot_Transition_Severity_Transition_To_Non_Recoverable", IPMI_INTERPRET_STATE_CRITICAL},
    { "IPMI_Drive_Slot_Transition_Severity_Monitor", IPMI_INTERPRET_STATE_WARNING},
...
static struct ipmi_interpret_sensor_config ipmi_interpret_sensor_system_firmware_progress_state_config[] =
  {
    { "IPMI_System_Firmware_Progress_State_No_Event", IPMI_INTERPRET_STATE_NOMINAL},
    { "IPMI_System_Firmware_Progress_State_Deasserted", IPMI_INTERPRET_STATE_NOMINAL},
    { "IPMI_System_Firmware_Progress_State_Asserted", IPMI_INTERPRET_STATE_WARNING},
  };
static unsigned int ipmi_interpret_sensor_system_firmware_progress_state_config_len = 3;

static struct ipmi_interpret_sensor_config ipmi_interpret_sensor_system_firmware_progress_device_present_config[] =
  {
    { "IPMI_System_Firmware_Progress_Device_Present_Device_No_Event", IPMI_INTERPRET_STATE_NOMINAL},
    { "IPMI_System_Firmware_Progress_Device_Present_Device_Removed_Device_Absent", IPMI_INTERPRET_STATE_CRITICAL},
    { "IPMI_System_Firmware_Progress_Device_Present_Device_Inserted_Device_Present", IPMI_INTERPRET_STATE_NOMINAL},
  };
static unsigned int ipmi_interpret_sensor_system_firmware_progress_device_present_config_len = 3;
...
static struct ipmi_interpret_sensor_config ipmi_interpret_sensor_version_change_config[] =
  {
    ...
    { "IPMI_Version_Change_Hardware_Incompatibility_Detected_With_Associated_Entity", IPMI_INTERPRET_STATE_CRITICAL},
    { "IPMI_Version_Change_Firmware_Or_Software_Incompatibility_Detected_With_Associated_Entity", IPMI_INTERPRET_STATE_CRITICAL},
...
interpret_sensor_init (ipmi_interpret_ctx_t ctx)
{
  ...
  if (_interpret_config_sensor_init (ctx,
                                     &ctx->interpret_sensor.ipmi_interpret_sensor_system_firmware_progress_state_config,
                                     ipmi_interpret_sensor_system_firmware_progress_state_config,
                                     ipmi_interpret_sensor_system_firmware_progress_state_config_len) < 0)
    goto cleanup;

  if (_interpret_config_sensor_init (ctx,
                                     &ctx->interpret_sensor.ipmi_interpret_sensor_system_firmware_progress_device_present_config,
                                     ipmi_interpret_sensor_system_firmware_progress_device_present_config,
                                     ipmi_interpret_sensor_system_firmware_progress_device_present_config_len) < 0)
    goto cleanup;
                               ...
                               const char *sensor_config_file)
{
  ...
  int ipmi_interpret_sensor_system_firmware_progress_state_flags[ipmi_interpret_sensor_system_firmware_progress_state_config_len];
  ...
  _fill_sensor_config_options (config_file_options,
                               &config_file_options_len,
                               ctx->interpret_sensor.ipmi_interpret_sensor_system_firmware_progress_state_config,
                               ipmi_interpret_sensor_system_firmware_progress_state_flags,
                               ipmi_interpret_sensor_system_firmware_progress_state_config_len);

  _fill_sensor_config_options (config_file_options,
                               &config_file_options_len,
                               ctx->interpret_sensor.ipmi_interpret_sensor_system_firmware_progress_device_present_config,
                               ipmi_interpret_sensor_system_firmware_progress_device_present_flags,
