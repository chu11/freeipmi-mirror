...
static struct ipmi_interpret_sel_config ipmi_interpret_sel_drive_slot_transition_severity_config[] =
  {
    { "IPMI_Drive_Slot_Transition_Severity_Transition_To_OK", IPMI_INTERPRET_STATE_NOMINAL, IPMI_INTERPRET_STATE_NOMINAL},
    { "IPMI_Drive_Slot_Transition_Severity_Transition_To_Non_Critical_From_OK", IPMI_INTERPRET_STATE_WARNING, IPMI_INTERPRET_STATE_WARNING},
    { "IPMI_Drive_Slot_Transition_Severity_Transition_To_Critical_From_Less_Severe", IPMI_INTERPRET_STATE_CRITICAL, IPMI_INTERPRET_STATE_CRITICAL},
    { "IPMI_Drive_Slot_Transition_Severity_Transition_To_Non_Recoverable_From_Less_Severe", IPMI_INTERPRET_STATE_CRITICAL, IPMI_INTERPRET_STATE_CRITICAL},
    { "IPMI_Drive_Slot_Transition_Severity_Transition_To_Non_Critical_From_More_Severe", IPMI_INTERPRET_STATE_WARNING, IPMI_INTERPRET_STATE_WARNING},
    { "IPMI_Drive_Slot_Transition_Severity_Transition_To_Critical_From_Non_Recoverable", IPMI_INTERPRET_STATE_CRITICAL, IPMI_INTERPRET_STATE_CRITICAL},
    ...
    { "IPMI_Drive_Slot_Transition_Severity_Monitor", IPMI_INTERPRET_STATE_WARNING, IPMI_INTERPRET_STATE_WARNING},
    { "IPMI_Drive_Slot_Transition_Severity_Informational", IPMI_INTERPRET_STATE_NOMINAL, IPMI_INTERPRET_STATE_NOMINAL},
  };
static unsigned int ipmi_interpret_sel_drive_slot_transition_severity_config_len = 9;
...
static struct ipmi_interpret_sel_config ipmi_interpret_sel_system_firmware_progress_state_config[] =
  {
    { "IPMI_System_Firmware_Progress_State_Deasserted", IPMI_INTERPRET_STATE_NOMINAL, IPMI_INTERPRET_STATE_NOMINAL},
    { "IPMI_System_Firmware_Progress_State_Asserted", IPMI_INTERPRET_STATE_WARNING, IPMI_INTERPRET_STATE_WARNING},
  };
static unsigned int ipmi_interpret_sel_system_firmware_progress_state_config_len = 2;
...
static struct ipmi_interpret_sel_config ipmi_interpret_sel_system_event_transition_severity_config[] =
  {
    { "IPMI_System_Event_Transition_Severity_Transition_To_OK", IPMI_INTERPRET_STATE_NOMINAL, IPMI_INTERPRET_STATE_NOMINAL},
    { "IPMI_System_Event_Transition_Severity_Transition_To_Non_Critical_From_OK", IPMI_INTERPRET_STATE_WARNING, IPMI_INTERPRET_STATE_WARNING},
    { "IPMI_System_Event_Transition_Severity_Transition_To_Critical_From_Less_Severe", IPMI_INTERPRET_STATE_CRITICAL, IPMI_INTERPRET_STATE_CRITICAL},
    { "IPMI_System_Event_Transition_Severity_Transition_To_Non_Recoverable_From_Less_Severe", IPMI_INTERPRET_STATE_CRITICAL, IPMI_INTERPRET_STATE_CRITICAL},
    { "IPMI_System_Event_Transition_Severity_Transition_To_Non_Critical_From_More_Severe", IPMI_INTERPRET_STATE_WARNING, IPMI_INTERPRET_STATE_WARNING},
    { "IPMI_System_Event_Transition_Severity_Transition_To_Critical_From_Non_Recoverable", IPMI_INTERPRET_STATE_CRITICAL, IPMI_INTERPRET_STATE_CRITICAL},
    { "IPMI_System_Event_Transition_Severity_Transition_To_Non_Recoverable", IPMI_INTERPRET_STATE_CRITICAL, IPMI_INTERPRET_STATE_CRITICAL},
    { "IPMI_System_Event_Transition_Severity_Monitor", IPMI_INTERPRET_STATE_WARNING, IPMI_INTERPRET_STATE_WARNING},
    { "IPMI_System_Event_Transition_Severity_Informational", IPMI_INTERPRET_STATE_NOMINAL, IPMI_INTERPRET_STATE_NOMINAL},
  };
static unsigned int ipmi_interpret_sel_system_event_transition_severity_config_len = 9;
...
static struct ipmi_interpret_sel_config ipmi_interpret_sel_version_change_config[] =
  {
    ...
    { "IPMI_Version_Change_Hardware_Incompatibility_Detected_With_Associated_Entity", IPMI_INTERPRET_STATE_CRITICAL, IPMI_INTERPRET_STATE_CRITICAL},
    { "IPMI_Version_Change_Firmware_Or_Software_Incompatibility_Detected_With_Associated_Entity", IPMI_INTERPRET_STATE_CRITICAL, IPMI_INTERPRET_STATE_CRITICAL},
...
interpret_sel_init (ipmi_interpret_ctx_t ctx)
{
  ...
  if (_interpret_config_sel_init (ctx,
                                  &ctx->interpret_sel.ipmi_interpret_sel_drive_slot_transition_severity_config,
                                  ipmi_interpret_sel_drive_slot_transition_severity_config,
                                  ipmi_interpret_sel_drive_slot_transition_severity_config_len) < 0)
    goto cleanup;
  ...
  if (_interpret_config_sel_init (ctx,
                                  &ctx->interpret_sel.ipmi_interpret_sel_system_firmware_progress_state_config,
                                  ipmi_interpret_sel_system_firmware_progress_state_config,
                                  ipmi_interpret_sel_system_firmware_progress_state_config_len) < 0)
    goto cleanup;
  ...
  if (_interpret_config_sel_init (ctx,
                                  &ctx->interpret_sel.ipmi_interpret_sel_system_event_transition_severity_config,
                                  ipmi_interpret_sel_system_event_transition_severity_config,
                                  ipmi_interpret_sel_system_event_transition_severity_config_len) < 0)
    goto cleanup;
                            ...
                            const char *sel_config_file)
{
  ...
  int ipmi_interpret_sel_drive_slot_transition_severity_flags[ipmi_interpret_sel_drive_slot_transition_severity_config_len];
  ...
  int ipmi_interpret_sel_system_firmware_progress_state_flags[ipmi_interpret_sel_system_firmware_progress_state_config_len];
  ...
  int ipmi_interpret_sel_system_event_transition_severity_flags[ipmi_interpret_sel_system_event_transition_severity_config_len];
  ...
  _fill_sel_config_options (config_file_options,
                            &config_file_options_len,
                            ctx->interpret_sel.ipmi_interpret_sel_drive_slot_transition_severity_config,
                            ipmi_interpret_sel_drive_slot_transition_severity_flags,
  ...
  _fill_sel_config_options (config_file_options,
                            &config_file_options_len,
                            ctx->interpret_sel.ipmi_interpret_sel_system_firmware_progress_state_config,
                            ipmi_interpret_sel_system_firmware_progress_state_flags,
  ...
  _fill_sel_config_options (config_file_options,
                            &config_file_options_len,
                            ctx->interpret_sel.ipmi_interpret_sel_system_event_transition_severity_config,
                            ipmi_interpret_sel_system_event_transition_severity_flags,
                            ipmi_interpret_sel_system_event_transition_severity_config_len);
