...
static pef_err_t
alert_policy_get (ipmi_pef_state_data_t *state_data,
...
static pef_err_t
alert_policy_set (ipmi_pef_state_data_t *state_data,
                  uint8_t alert_policy_entry_number,
                  uint8_t policy_type,
...
static pef_err_t
policy_type_checkout (ipmi_pef_state_data_t *state_data,
...
static pef_err_t
policy_type_commit (ipmi_pef_state_data_t *state_data,
                    const struct section *sect,
...
static pef_diff_t
policy_type_diff (ipmi_pef_state_data_t *state_data,
                  const struct section *sect,
                  const struct keyvalue *kv)
{
  uint8_t get_val;
...
static pef_err_t
policy_enabled_checkout (ipmi_pef_state_data_t *state_data,
                         const struct section *sect,
                         struct keyvalue *kv)
{
  uint8_t policy_enabled;
...
static pef_err_t
policy_enabled_commit (ipmi_pef_state_data_t *state_data,
                       const struct section *sect,
                       const struct keyvalue *kv)
{
  uint8_t alert_policy_entry_number;
...
static pef_diff_t
policy_enabled_diff (ipmi_pef_state_data_t *state_data,
                     const struct section *sect,
                     const struct keyvalue *kv)
{
  uint8_t get_val;
...
static pef_err_t
policy_number_checkout (ipmi_pef_state_data_t *state_data,
                        const struct section *sect,
                        struct keyvalue *kv)
{
  uint8_t policy_number;
...
static pef_err_t
policy_number_commit (ipmi_pef_state_data_t *state_data,
                      const struct section *sect,
                      const struct keyvalue *kv)
{
  uint8_t alert_policy_entry_number;
...
static pef_diff_t
policy_number_diff (ipmi_pef_state_data_t *state_data,
                    const struct section *sect,
                    const struct keyvalue *kv)
{
  uint8_t get_val;
...
static pef_err_t
destination_selector_checkout (ipmi_pef_state_data_t *state_data,
                               const struct section *sect,
                               struct keyvalue *kv)
{
  uint8_t destination_selector;
...
static pef_err_t
destination_selector_commit (ipmi_pef_state_data_t *state_data,
                             const struct section *sect,
                             const struct keyvalue *kv)
{
  uint8_t alert_policy_entry_number;
...
static pef_diff_t
destination_selector_diff (ipmi_pef_state_data_t *state_data,
                           const struct section *sect,
                           const struct keyvalue *kv)
{
  uint8_t get_val;
...
static pef_err_t
channel_number_checkout (ipmi_pef_state_data_t *state_data,
                         const struct section *sect,
                         struct keyvalue *kv)
{
  uint8_t channel_number;
...
static pef_err_t
channel_number_commit (ipmi_pef_state_data_t *state_data,
                       const struct section *sect,
                       const struct keyvalue *kv)
{
  uint8_t alert_policy_entry_number;
...
static pef_diff_t
channel_number_diff (ipmi_pef_state_data_t *state_data,
                     const struct section *sect,
                     const struct keyvalue *kv)
{
  uint8_t get_val;
...
static pef_err_t
alert_string_set_selector_checkout (ipmi_pef_state_data_t *state_data,
                                    const struct section *sect,
                                    struct keyvalue *kv)
{
  uint8_t alert_string_set_selector;
...
static pef_err_t
alert_string_set_selector_commit (ipmi_pef_state_data_t *state_data,
                                  const struct section *sect,
                                  const struct keyvalue *kv)
{
  uint8_t alert_policy_entry_number;
...
static pef_diff_t
alert_string_set_selector_diff (ipmi_pef_state_data_t *state_data,
                                const struct section *sect,
                                const struct keyvalue *kv)
{
  uint8_t get_val;
...
static pef_err_t
event_specific_alert_string_checkout (ipmi_pef_state_data_t *state_data,
                                      const struct section *sect,
                                      struct keyvalue *kv)
{
  uint8_t event_specific_alert_string;
...
static pef_err_t
event_specific_alert_string_commit (ipmi_pef_state_data_t *state_data,
                                    const struct section *sect,
                                    const struct keyvalue *kv)
{
  uint8_t alert_policy_entry_number;
...
static pef_diff_t
event_specific_alert_string_diff (ipmi_pef_state_data_t *state_data,
                                  const struct section *sect,
                                  const struct keyvalue *kv)
{
  uint8_t get_val;
