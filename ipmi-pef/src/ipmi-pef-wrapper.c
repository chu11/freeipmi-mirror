...
pef_err_t
get_pef_control (ipmi_pef_state_data_t *state_data,
                 uint8_t *pef,
...
pef_err_t
set_pef_control (ipmi_pef_state_data_t *state_data,
                 uint8_t pef,
                 uint8_t pef_event_messages,
                 uint8_t pef_startup_delay,
                 uint8_t pef_alert_startup_delay)
...
pef_err_t
get_pef_action_global_control (ipmi_pef_state_data_t *state_data,
...
pef_err_t
set_pef_action_global_control (ipmi_pef_state_data_t *state_data,
                               uint8_t alert_action,
                               uint8_t power_down_action,
                               uint8_t reset_action,
                               uint8_t power_cycle_action,
...
pef_err_t
get_pef_startup_delay (ipmi_pef_state_data_t *state_data,
                       uint8_t *pef_startup_delay)
{
  fiid_obj_t obj_cmd_rs = NULL;
  uint64_t val = 0;
...
pef_err_t
set_pef_startup_delay (ipmi_pef_state_data_t *state_data,
                       uint8_t pef_startup_delay)
{
  fiid_obj_t obj_cmd_rs = NULL;
  pef_err_t rv = PEF_ERR_FATAL_ERROR;
...
pef_err_t
get_pef_alert_startup_delay (ipmi_pef_state_data_t *state_data,
                             uint8_t *pef_alert_startup_delay)
{
  fiid_obj_t obj_cmd_rs = NULL;
  uint64_t val = 0;
...
pef_err_t
set_pef_alert_startup_delay (ipmi_pef_state_data_t *state_data,
                             uint8_t pef_alert_startup_delay)
{
  fiid_obj_t obj_cmd_rs = NULL;
  pef_err_t rv = PEF_ERR_FATAL_ERROR;
