...
#include "ipmi-config-core-lan-conf-section.h"
#include "ipmi-config-core-lan-conf-auth-section.h"
#include "ipmi-config-core-lan-conf-security-keys-section.h"
#include "ipmi-config-core-lan-conf-misc-section.h"
#include "ipmi-config-core-lan-conf-user-security-section.h"
#include "ipmi-config-core-misc-section.h"
#include "ipmi-config-core-pef-conf-section.h"
#include "ipmi-config-core-rmcpplus-conf-privilege-section.h"
#include "ipmi-config-core-serial-channel-section.h"
#include "ipmi-config-core-serial-conf-section.h"
#include "ipmi-config-core-sol-conf-section.h"
#include "ipmi-config-core-user-sections.h"
