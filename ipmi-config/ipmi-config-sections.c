...
#include "ipmi-config-lan-channel-section.h"
#include "ipmi-config-lan-conf-section.h"
#include "ipmi-config-lan-conf-auth-section.h"
#include "ipmi-config-lan-conf-security-keys-section.h"
#include "ipmi-config-lan-conf-misc-section.h"
#include "ipmi-config-lan-conf-user-security-section.h"
#include "ipmi-config-pef-conf-section.h"
#include "ipmi-config-rmcpplus-conf-privilege-section.h"
#include "ipmi-config-serial-channel-section.h"
#include "ipmi-config-serial-conf-section.h"
#include "ipmi-config-sol-conf-section.h"
#include "ipmi-config-misc-section.h"
