                                     ...
                                     void *arg)
{
  ...
  return (ipmi_config_check_number_range (value, 0, 7));
}
                                    ...
                                    void *arg)
{
  ...
  return (ipmi_config_check_number_range (value, 0, 15));
}
                                     ...
                                     void *arg)
{
  ...
  return (ipmi_config_check_number_range (value, 0, 127));
}
                                   ...
                                   void *arg)
{
  ...
  return (ipmi_config_check_number_range (value, 0, 255));
}
                                            ...
                                            void *arg)
{
  ...
  return (ipmi_config_check_number_range (value, 1, 255));
}
                                    ...
                                    void *arg)
{
  ...
  return (ipmi_config_check_number_range (value, 0, 65535));
}
