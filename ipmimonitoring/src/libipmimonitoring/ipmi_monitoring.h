/*****************************************************************************\
 *  $Id: ipmi_monitoring.h,v 1.54.2.1 2009-12-29 00:04:52 chu11 Exp $
 *****************************************************************************
...
enum ipmi_monitoring_error_codes
  {
    ...
    IPMI_MONITORING_ERR_CONFIG_FILE_PARSE                   = 7,
    IPMI_MONITORING_ERR_SENSOR_CONFIG_FILE_PARSE            = 8,
    IPMI_MONITORING_ERR_SDR_CACHE_PERMISSION                = 9,
    IPMI_MONITORING_ERR_SDR_CACHE_FILESYSTEM                = 10,
    IPMI_MONITORING_ERR_HOSTNAME_INVALID                    = 11,
    IPMI_MONITORING_ERR_SENSOR_NOT_FOUND                    = 12,
    IPMI_MONITORING_ERR_NO_SENSOR_READINGS                  = 13,
    IPMI_MONITORING_ERR_SENSOR_READINGS_LIST_END            = 14,
    IPMI_MONITORING_ERR_CONNECTION_TIMEOUT                  = 15,
    IPMI_MONITORING_ERR_SESSION_TIMEOUT                     = 16,
    IPMI_MONITORING_ERR_USERNAME_INVALID                    = 17,
    IPMI_MONITORING_ERR_PASSWORD_INVALID                    = 18,
    IPMI_MONITORING_ERR_PASSWORD_VERIFICATION_TIMEOUT       = 19,
    IPMI_MONITORING_ERR_K_G_INVALID                         = 20,
    IPMI_MONITORING_ERR_PRIVILEGE_LEVEL_INSUFFICIENT        = 21,
    IPMI_MONITORING_ERR_PRIVILEGEL_LEVEL_CANNOT_BE_OBTAINED = 22,
    IPMI_MONITORING_ERR_AUTHENTICATION_TYPE_UNAVAILABLE     = 23,
    IPMI_MONITORING_ERR_IPMI_2_0_UNAVAILABLE                = 24,
    IPMI_MONITORING_ERR_CIPHER_SUITE_ID_UNAVAILABLE         = 25,
    IPMI_MONITORING_ERR_CALLBACK_ERROR                      = 26,
