/*****************************************************************************\
 *  $Id: ipmi_monitoring.h,v 1.26.2.1 2008-08-22 00:02:46 chu11 Exp $
 *****************************************************************************
...
enum ipmi_monitoring_sensor_bitmask_management_subsystem_health
  {
    ...
    IPMI_MONITORING_BITMASK_MANAGEMENT_SUBSYSTEM_HEALTH_MANAGEMENT_CONTROLLER_OFF_LINE = 0x0003,
    IPMI_MONITORING_BITMASK_MANAGEMENT_SUBSYSTEM_HEALTH_MANAGEMENT_CONTROLLER_UNAVAILABLE = 0x0004,
    IPMI_MONITORING_BITMASK_MANAGEMENT_SUBSYSTEM_HEALTH_SENSOR_FAILURE = 0x0005,
    IPMI_MONITORING_BITMASK_MANAGEMENT_SUBSYSTEM_HEALTH_FRU_FAILURE = 0x0006,
  };
...
enum ipmi_monitoring_sensor_bitmask_battery
  {
    ...
    IPMI_MONITORING_BITMASK_BATTERY_BATTERY_PRESENCE_DETECTED = 0x0003,
  };
...
enum ipmi_monitoring_sensor_bitmask_fru_state
  {
    ...
    IPMI_MONITORING_BITMASK_FRU_STATE_FRU_ACTIVATION_REQUESTED = 0x0003,
    IPMI_MONITORING_BITMASK_FRU_STATE_FRU_ACTIVATION_IN_PROGRESS = 0x0004,
    IPMI_MONITORING_BITMASK_FRU_STATE_FRU_ACTIVE = 0x0005,
    IPMI_MONITORING_BITMASK_FRU_STATE_FRU_DEACTIVATION_REQUESTED = 0x0006,
    IPMI_MONITORING_BITMASK_FRU_STATE_FRU_DEACTIVATION_IN_PROGRESS = 0x0007,
    IPMI_MONITORING_BITMASK_FRU_STATE_FRU_COMMUNICATION_LOST = 0x0008,
  };
