/*****************************************************************************\
 *  $Id: ipmi_monitoring_ipmi_communication.c,v 1.35.4.2 2010-06-04 21:35:35 chu11 Exp $
 *****************************************************************************
  ...
  if (config && config->workaround_flags)
    {
      ...
      if (config->workaround_flags & IPMI_MONITORING_WORKAROUND_FLAGS_SUPERMICRO_2_0_SESSION_B)
