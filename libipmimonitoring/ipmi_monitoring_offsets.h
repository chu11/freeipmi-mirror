...
enum ipmi_monitoring_event_offset_version_change
  {
    ...
    IPMI_MONITORING_EVENT_OFFSET_VERSION_CHANGE_HARDWARE_INCOMPATIBILITY_DETECTED_WITH_ASSOCIATED_ENTITY               = 0x02,
    IPMI_MONITORING_EVENT_OFFSET_VERSION_CHANGE_FIRMWARE_OR_SOFTWARE_INCOMPATIBILITY_DETECTED_WITH_ASSOCIATED_ENTITY   = 0x03,
