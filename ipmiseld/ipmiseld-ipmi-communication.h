...
#ifndef IPMISELD_IPMI_COMMUNICATION_H
#define IPMISELD_IPMI_COMMUNICATION_H

#include "ipmiseld.h"

int ipmiseld_ipmi_setup (ipmiseld_host_data_t *host_data);

#endif /* IPMISELD_IPMI_COMMUNICATION_H */
