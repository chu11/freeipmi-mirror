		   ...
		   struct keyvalue *kv)
{
  ...
  /* achu: Some BMC's don't support user id 1 or other random user id
     ...
     BMC_NO_CHECKOUT_ON_EARLIER_SECTION_FAILURE_FLAG flag in the various
     sections afterward.
  */
...
get_user_section (int num, struct arguments *args)
{
  ...
  add_keyvalue (this_section,
		...
		"Possible values: Yes/No or blank to not set",
                BMC_CHECKOUT_KEY_COMMENTED_OUT | BMC_NO_CHECKOUT_ON_EARLIER_SECTION_FAILURE_FLAG,
  ...
  add_keyvalue (this_section,
		...
		"Possible values: Yes/No",
                BMC_NO_CHECKOUT_ON_EARLIER_SECTION_FAILURE_FLAG,
  ...
  add_keyvalue (this_section,
		...
		"Possible values: Yes/No",
                BMC_DO_NOT_CHECKOUT | BMC_NO_CHECKOUT_ON_EARLIER_SECTION_FAILURE_FLAG,
		lan_enable_restricted_to_callback_checkout,
		lan_enable_restricted_to_callback_commit,
		lan_enable_restricted_to_callback_diff,
		lan_enable_restricted_to_callback_validate);
