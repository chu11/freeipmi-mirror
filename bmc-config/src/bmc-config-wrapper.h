...
config_err_t set_bmc_lan_conf_authentication_type_enables (bmc_config_state_data_t *state_data, 
...
config_err_t set_k_g(bmc_config_state_data_t *state_data,
                     uint8_t *k_g,
                     uint32_t k_g_len);
...
config_err_t get_bmc_lan_conf_authentication_type_enables (bmc_config_state_data_t *state_data, 
                                                           uint8_t *callback_level_none,
                                                           uint8_t *callback_level_md2,
                                                           uint8_t *callback_level_md5,
                                                           uint8_t *callback_level_straight_password,
...
config_err_t get_k_g(bmc_config_state_data_t *state_data,
                     uint8_t *k_g,
                     uint32_t k_g_len);
