  ...
  {
    {
      ...
      "mode=globalpower|globaltemp|policypower|policytrigger|policythrottling|hostunhandledrequests|hostresponsetime|cputhrottling|memorythrottling|hostcommfailure [domainid=platform|cpu|memory|highpowerio|<num>] [policyid=num]",
      1,
      IPMI_OEM_COMMAND_FLAGS_OPTIONS_COUNT_VARIABLE,
    ...
    },
    {
      ...
      "[mode=global|policy|hostunhandledrequests|hostresponsetime|cputhrottling|memorythrottling|hostcommfailure] [domainid=platform|cpu|memory|highpowerio|<num>] [policyid=num]",
      0,
      IPMI_OEM_COMMAND_FLAGS_OPTIONS_COUNT_VARIABLE,
    ...
    },
    {
      ...
      "[domainid=platform|cpu|memory|highpowerio|<num>] [policytrigger=none|inlettemperaturelimitpolicytrigger|missingpowerreadingtimeout|timeafterplatformresettrigger|boottimepolicy] [policytype=powercontrol]",
      0,
      IPMI_OEM_COMMAND_FLAGS_OPTIONS_COUNT_VARIABLE,
    ...
    },
    {
      ...
      "<enable|disable> [domainid=platform|cpu|memory|highpowerio|<num>] [policyid=num]",
      1,
      IPMI_OEM_COMMAND_FLAGS_OPTIONS_COUNT_VARIABLE,
    ...
    },
    {
      ...
      "[domainid=platform|cpu|memory|highpowerio|<num>] [policyid=num]",
      0,
      IPMI_OEM_COMMAND_FLAGS_OPTIONS_COUNT_VARIABLE,
    ...
    },
    {
      ...
      "domainid=platform|cpu|memory|highpowerio|<num> policyid=num policytrigger=none|inlettemperaturelimitpolicytrigger|missingpowerreadingtimeout|timeafterplatformresettrigger|boottimepolicy powerlimit=watts correctiontimelimit=ms policytriggerlimit=num statisticsreportingperiod=seconds [policystate=enable|disable] [policyexceptionaction=alert|shutdown]",
      7,
      IPMI_OEM_COMMAND_FLAGS_OPTIONS_COUNT_VARIABLE,
    ...
    },
    {
      ...
      "domainid=platform|cpu|memory|highpowerio|<num> policyid=num [threshold1=num] [threshold2=num] [threshold3=num]",
      2,
      IPMI_OEM_COMMAND_FLAGS_OPTIONS_COUNT_VARIABLE,
    ...
    },
    {
      ...
      "domainid=platform|cpu|memory|highpowerio|<num> policyid=num suspendperiodstartX=time suspendperiodstopX=time suspendperiodrepeatX=monday|tuesday|wednesday|thursday|friday|saturday|sunday",
      2,
      IPMI_OEM_COMMAND_FLAGS_OPTIONS_COUNT_VARIABLE,
    ...
    },
    {
      ...
      "domainid=platform|cpu|memory|highpowerio|<num> minpowerdrawrange=watts maxpowerdrawrange=watts",
      3,
      IPMI_OEM_COMMAND_FLAGS_DEFAULT,
