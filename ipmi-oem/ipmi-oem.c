...
struct ipmi_oem_command oem_intelnm[] =
  {
    ...
    },
    {
      ...
      "[domainid=id] [policytrigger=none|inlet] [policytype=powercontrol]",
      0,
      IPMI_OEM_COMMAND_FLAGS_OPTIONS_COUNT_VARIABLE,
    ...
    },
    {
      ...
      "<enable|disable> [domainid=id] [policyid=num]",
      1,
      IPMI_OEM_COMMAND_FLAGS_OPTIONS_COUNT_VARIABLE,
    ...
    },
    {
      ...
      "domainid=id policyid=num policytrigger=none|inlet powerlimit=watts correctiontimelimit=ms policytriggerlimit=num statisticsreportingperiod=seconds [policystate=enable|disable] [policyexceptionaction=alert|shutdown]",
      7,
      IPMI_OEM_COMMAND_FLAGS_OPTIONS_COUNT_VARIABLE,
    ...
    },
    {
      ...
      "domainid=id policyid=num [threshold1=num] [threshold2=num] [threshold3=num]",
      2,
      IPMI_OEM_COMMAND_FLAGS_OPTIONS_COUNT_VARIABLE,
    ...
    },
    {
      ...
      "domainid=id policyid=num suspendperiodstartX=time suspendperiodstopX=time suspendperiodrepeatX=monday|tuesday|wednesday|thursday|friday|saturday|sunday",
      2,
      IPMI_OEM_COMMAND_FLAGS_OPTIONS_COUNT_VARIABLE,
    ...
    },
    {
      ...
      "domainid=id minpowerdrawrange=watts maxpowerdrawrange=watts",
      3,
      IPMI_OEM_COMMAND_FLAGS_DEFAULT,
