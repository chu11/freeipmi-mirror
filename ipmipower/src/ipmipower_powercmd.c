/*****************************************************************************\
 *  $Id: ipmipower_powercmd.c,v 1.16.2.4 2006-01-29 16:08:00 chu11 Exp $
 *****************************************************************************
...
{ 
  ...
  ip->session_req = Fiid_obj_create(tmpl_hdr_session_auth_calc); 
  ip->session_res = Fiid_obj_create(tmpl_hdr_session_auth_calc); 
