/*****************************************************************************\
 *  $Id: ipmipower_ping.c,v 1.11.2.1 2006-02-13 18:48:44 chu11 Exp $
 *****************************************************************************
          ...
          if (conf->rmcpdump) 
            {
              char *hdr = 
                ...
                "= RMCP Ping                                =\n"
                "============================================";
              Ipmi_dump_rmcp_packet(STDERR_FILENO, ics[i].hostname, hdr, 
      ...
      if (len > 0) 
        {
          ...
          if (unassemble_rmcp_pkt(buffer, len, tmpl_cmd_asf_presence_pong, 
                                  rmcp_hdr, rmcp_pong) < 0)
