...
# FreeIPMI's ipmimonitoring utility.
#
...
# supply, power unit, memory, drive slot, syste firmware progress,
...
# argument or IPMIMONITORING_ARGS environment variable.  Typically, this
