##*****************************************************************************
## $Id: ac_freeipmi_interpret_sensor_config_file.m4,v 1.1.2.1 2010-01-06 23:25:14 chu11 Exp $
##*****************************************************************************

AC_DEFUN([AC_INTERPRET_SENSOR_CONFIG_FILE],
[
# Must expand nested unquoting
  INTERPRET_SENSOR_CONFIG_FILE_DEFAULT_TMP1="`eval echo ${sysconfdir}/ipmi_monitoring_sensors.conf`"
