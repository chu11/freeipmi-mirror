  ...
  struct conffile_option ipmi_sel_options[] =
    {
      ...
      {
        "ipmi-sel-show-sensor-type",
        CONFFILE_OPTION_BOOL,
        -1,
        config_file_bool,
        1,
        0,
        &(ipmi_sel_data.show_sensor_type_count),
        &(ipmi_sel_data.show_sensor_type),
        0,
      },
      {
  ...
  struct conffile_option ipmi_sensors_options[] =
    {
      ...
      {
        "ipmi-sensors-show-sensor-type",
        CONFFILE_OPTION_BOOL,
        -1,
        config_file_bool,
        1,
        0,
        &(ipmi_sensors_data.show_sensor_type_count),
        &(ipmi_sensors_data.show_sensor_type),
        0,
      },
      {
  ...
  struct conffile_option ipmimonitoring_options[] =
    {
      ...
      {
        "ipmimonitoring-show-sensor-type",
        CONFFILE_OPTION_BOOL,
        -1,
        config_file_bool,
        1,
        0,
        &(ipmimonitoring_data.show_sensor_type_count),
        &(ipmimonitoring_data.show_sensor_type),
        0,
      },
      {
