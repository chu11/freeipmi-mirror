  ...
  struct conffile_option ipmi_sel_options[] =
    {
      ...
      {
        "ipmi-sel-no-sensor-type",
        CONFFILE_OPTION_BOOL,
        -1,
        config_file_bool,
        1,
        0,
        &(ipmi_sel_data.no_sensor_type_count),
        &(ipmi_sel_data.no_sensor_type),
        0,
      },
      {
  ...
  struct conffile_option ipmi_sensors_options[] =
    {
      ...
      {
        "ipmi-sensors-no-sensor-type",
        CONFFILE_OPTION_BOOL,
        -1,
        config_file_bool,
        1,
        0,
        &(ipmi_sensors_data.no_sensor_type_count),
        &(ipmi_sensors_data.no_sensor_type),
        0,
      },
      {
  ...
  struct conffile_option ipmimonitoring_options[] =
    {
      ...
      {
        "ipmimonitoring-no-sensor-type",
        CONFFILE_OPTION_BOOL,
        -1,
        config_file_bool,
        1,
        0,
        &(ipmimonitoring_data.no_sensor_type_count),
        &(ipmimonitoring_data.no_sensor_type),
        0,
      },
      {
