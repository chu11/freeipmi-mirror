  ...
  struct conffile_option ipmi_sensors_options[] =
    {
      ...
      {
        "ipmi-sensors-interpret-oem-sensors",
        CONFFILE_OPTION_BOOL,
        -1,
        config_file_bool,
        1,
        0,
        &(ipmi_sensors_data.interpret_oem_sensors_count),
        &(ipmi_sensors_data.interpret_oem_sensors),
        0,
      },
      {
  ...
  struct conffile_option ipmimonitoring_options[] =
    {
      ...
      {
        "ipmimonitoring-interpret-oem-sensors",
        CONFFILE_OPTION_BOOL,
        -1,
        config_file_bool,
        1,
        0,
        &(ipmimonitoring_data.interpret_oem_sensors_count),
        &(ipmimonitoring_data.interpret_oem_sensors),
        0,
      },
      {
