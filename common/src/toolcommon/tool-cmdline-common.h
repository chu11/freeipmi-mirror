...
#define IPMI_TOOL_WORKAROUND_FLAGS_IGNORE_SOL_PAYLOAD_SIZE     0x00000100
#define IPMI_TOOL_WORKAROUND_FLAGS_IGNORE_SOL_PORT             0x00000200
#define IPMI_TOOL_WORKAROUND_FLAGS_ALWAYS_RESERVE              0x00000400
...
#define IPMI_TOOL_WORKAROUND_FLAGS_ALWAYS_RESERVE_STR              "alwaysreserve"
