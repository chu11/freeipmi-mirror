...
#define IPMI_TOOL_WORKAROUND_FLAGS_NON_EMPTY_INTEGRITY_CHECK_VALUE 0x00000200
#define IPMI_TOOL_WORKAROUND_FLAGS_ASSUME_IO_BASE_ADDRESS          0x00000400
...
#define IPMI_TOOL_WORKAROUND_FLAGS_NON_EMPTY_INTEGRITY_CHECK_VALUE_STR "integritycheckvalue"
#define IPMI_TOOL_WORKAROUND_FLAGS_ASSUME_IO_BASE_ADDRESS_STR          "assumeio"
