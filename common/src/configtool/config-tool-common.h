...
typedef enum
  {
    CONFIG_ERR_FATAL_ERROR = -6,
    CONFIG_ERR_NON_FATAL_ERROR = -5,
    CONFIG_ERR_NON_FATAL_ERROR_READ_ONLY = -4,
    CONFIG_ERR_NON_FATAL_ERROR_NOT_SUPPORTED = -3,
    CONFIG_ERR_NON_FATAL_ERROR_INVALID_UNSUPPORTED_CONFIG = -2,
    CONFIG_ERR_NON_FATAL_ERROR_REQUIRED_FIELD_NOT_FOUND = -1,
...
#define CONFIG_IS_NON_FATAL_ERROR(__ret) \
  (((__ret) == CONFIG_ERR_NON_FATAL_ERROR \
    ...
    || (__ret) == CONFIG_ERR_NON_FATAL_ERROR_NOT_SUPPORTED \
    || (__ret) == CONFIG_ERR_NON_FATAL_ERROR_INVALID_UNSUPPORTED_CONFIG \
    || (__ret) == CONFIG_ERR_NON_FATAL_ERROR_REQUIRED_FIELD_NOT_FOUND) ? 1 : 0)
