 ...
 */
int
ipmi_sensors_oem_intel_s2600jf_output_oem_record (ipmi_sensors_state_data_t *state_data,
                                                  ...
                                                  unsigned int oem_data_len)
{
  ...
  assert (state_data->oem_data.product_id == IPMI_INTEL_PRODUCT_ID_S2600JF);
