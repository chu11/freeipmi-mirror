/*****************************************************************************\
 *  $Id: bmc-watchdog-argp.c,v 1.13.8.1 2009-03-03 01:40:47 chu11 Exp $
 *****************************************************************************
...
static struct argp_option cmdline_options[] =
  {
    ...
    { "help", HELP_KEY, NULL, 0,
      "Output help.", 58},
    /* legacy short option */
    { "bogus-long-option1", HELP2_KEY, NULL, 0,
      "Output help.", 59},
    /* legacy short option */
    { "bogus-long-option1", HELP3_KEY, NULL, 0,
      "Output help.", 60},
    { 0 }
  };
